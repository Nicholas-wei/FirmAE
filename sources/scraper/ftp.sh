...
wget --mirror -A image --ignore-case ftp://ftp.avm.de/fritz.box -P output --no-check-certicicate

wget --mirror -A img,chk,bin,stk,zip,tar,sys,rar,pkg,rmt --ignore-case ftp://downloads.netgear.com -P output

wget --mirror -A zip --ignore-case ftp://ftp.zyxel.com -P output --no-check-certicicate

wget --mirror -A bin --ignore-case ftp://ftp.dd-wrt.com -P output --no-check-certicicate
